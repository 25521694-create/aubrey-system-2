...
export const metadata: Metadata = {
  title: "Deep Research | Analyses & Development | Aubrey Intelligence",
  description: "Deep Research articles for targeted technical development inside Aubrey-System.",
}

export default function DeepResearchListingPage() {
  const posts = getAllResearchMeta("deep-research").map((meta) => ({
    title: meta.title,
  ...
  return (
    <>
      <PageIntro
        ...
        title="Deep Research"
        description="Information systems and AI capabilities to develop selected Aubrey branches in depth, using institute and university resources for concrete branch-specific progress."
      />
